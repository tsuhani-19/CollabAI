...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      {/* Neon glowing squares */}
      <div className="absolute top-10 left-20 w-16 h-16 border-2 border-purple-400 rotate-45 animate-bounce-slow shadow-[0_0_20px_#a855f7]"></div>
      <div className="absolute bottom-16 right-24 w-20 h-20 border-2 border-pink-400 rotate-12 animate-bounce-slow shadow-[0_0_25px_#ec4899]"></div>
      ...
      >
        ...
        {/* Forgot Password */}
        <div className="text-right text-sm text-purple-300 hover:text-purple-400 mb-6 cursor-pointer">
          Forgot password?
        </div>
